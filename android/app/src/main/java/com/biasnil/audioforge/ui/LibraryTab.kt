 ...
 * off in Settings > Visible tabs (same five as the desktop).
 */
enum class LibraryTab(@StringRes val title: Int, val hideable: Boolean) {
    ...
    Wallpapers(R.string.tab_wallpapers, hideable = false),
